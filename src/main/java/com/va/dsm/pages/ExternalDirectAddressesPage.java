...
public class ExternalDirectAddressesPage extends LoadDriver {

	public ExternalDirectAddressesPage(WebDriver driver) {
	...
	private static WebElement DSM_Email_Internal_Direct_Address_Btn;
	...
	public static void Test_DSM_Email_Directory_Search_InternalVA_Addresses(String excelFilePath, String sheetName) throws Exception {
		...
		try {
			...
			if (driver.getTitle().startsWith("VA Direct Project")) {
				...
				CommonUtil.click(driver, DSM_Email_Internal_Direct_Address_Btn, 360);
