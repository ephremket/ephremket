...
public class DSMEmailPage extends LoadDriver {

    public DSMEmailPage(WebDriver driver) {
    ...
    @FindBy(how = How.XPATH, using = "//*[@id=\"compose_btn\"]")
    ...
    @FindBy(how = How.XPATH, using = "//*[@id=\"cc-markup-container\"]/div/ul")
    ...
    @FindBy(how = How.XPATH, using = "//input[@name='patient_id']")
    ...
    @FindBy(how = How.XPATH, using = "//*[@id=\"message_body_ifr\"]")
    ...
    @FindBy(how = How.XPATH,using = "//*[@id=\"feedback-type-field-issue-report\"]")
    private static WebElement DSM_Email_Report_Issue_Radio_Btn;
    @FindBy(how = How.XPATH, using = "/html/body/div[9]/div[3]/div/button[1]")
...
//							}
                            ...
                            if (noAttachmentExcelData.get(String.valueOf(k)).get("Body") != null) {
                                CommonUtil.click(driver, DSM_Email_Compose_Body, 360);
                                Thread.sleep(200);
                ...
                if (accountSettingsExcelData != null) {
                    for (int k = 1; k < accountSettingsExcelData.size() + 1; k++) {
                        ...
                        if (accountSettingsExcelData.get(String.valueOf(k)).get("Run Script").equals("Yes")) {
                            ...
                            Thread.sleep(500);
                            if (accountSettingsExcelData.get(String.valueOf(k)).get("Non-Clinical")
                                    != null && accountSettingsExcelData.get(String.valueOf(k)).get("Non-Clinical").equals("Yes")) {
                                WebElement nonClinicalCheckbox = driver.findElement(By.xpath("//*[@id=\"set_default_nucc\"]"));
                                if (!nonClinicalCheckbox.isSelected()) {
                                    nonClinicalCheckbox.click();
                                    Thread.sleep(50);
                                }
                            }
                        ...
                        if (automaticRepliesExcelData.get(String.valueOf(k)).get("Run Script").equals("Yes")) {
                            ...
                            if (automaticRepliesExcelData.get(String.valueOf(k)).get("Do not send automatic replies") != null && automaticRepliesExcelData.get(String.valueOf(k)).get("Do not send automatic replies").equals("Yes")) {
                                ...
                                if (!DSM_Email_Automatic_Replies_DoNot_Send_Radio_Btn.isSelected()) {
                                    DSM_Email_Automatic_Replies_DoNot_Send_Radio_Btn.click();
                                    Thread.sleep(50);
                                }
                                Thread.sleep(500);
                            } else {
                                ...
                                if (!DSM_Email_Automatic_Replies_Send_Radio_Btn.isSelected()) {
                                    DSM_Email_Automatic_Replies_Send_Radio_Btn.click();
                                    Thread.sleep(100);
                                }
...
//                                    DSM_Email_Report_Issue_Radio_Btn.click();
//                                    Thread.sleep(200);
//                                }
