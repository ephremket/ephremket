...
public class InternalDirectAddressesPage extends LoadDriver {

	public InternalDirectAddressesPage(WebDriver driver) {
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"toggleAdvancedSearch\"]")
